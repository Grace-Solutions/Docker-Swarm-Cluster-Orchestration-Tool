...
- `./cluster-master-init.sh --state-dir /mnt/GlusterFS/0001/data --enable-glusterfs`
...
- `./cluster-master-serve.sh --state-dir /mnt/GlusterFS/0001/data --listen 0.0.0.0:7000 --wait-for-minimum --min-managers 1 --min-workers 1`
